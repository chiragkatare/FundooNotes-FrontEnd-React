      ...
      <div>
        <Card id='verify-card'>
          ...
          <div className='label-page' >
            ...
            <div>
              <Typography className='label-text' align='center' variant='h5' component='h4' >Welcome</Typography>
              <Typography className='label-text' component='p' >Glad to have you</Typography>
            </div>
          </div>
